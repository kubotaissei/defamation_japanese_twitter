...
# https://levelup.gitconnected.com/kaggle-knowledge-points-berts-five-pooling-methods-b55d61dd9968
...
def get_pooling(pool_class, **params):
    print("pool class:", pool_class)
    f = globals().get(pool_class)
    return f(**params)
